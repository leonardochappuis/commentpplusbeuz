...
func TestCommenterNewBasics(t *testing.T) {
	...
	if _, err := commenterNew("test@example.com", "Test", "undefined", "https://example.com/photo.jpg", "google", "", "undefined"); err != nil {
...
func TestCommenterNewEmpty(t *testing.T) {
	...
	if _, err := commenterNew("", "Test", "undefined", "https://example.com/photo.jpg", "google", "", "undefined"); err == nil {
...
func TestCommenterNewCommento(t *testing.T) {
	...
	if _, err := commenterNew("test@example.com", "Test", "undefined", "", "commento", "", "undefined"); err == nil {
